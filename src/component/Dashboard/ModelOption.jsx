...
const ModelOption = (props) => {
	...
	return (
		statusModel && (
			<div className='fixed top-0 left-0 right-0 bottom-0 z-[100000] backdrop-blur-sm bg-black/30'>
				<div className='fixed bottom-0 left-[15px] right-[15px] bg-white rounded-tr-[15px] rounded-tl-[15px] p-[18px] pb-24 shadow-2xl border border-gray-200'>
